 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2021-APR-15  07:27:34 PM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("callStartTime");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.ELABORATED__EXCEPTION, "", null, session, false, false );
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.BILLING_TRANSFER_FLAG, "", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.DB_INSERT_CALL_AND_MENU_HISTORY_FIELD_CALL__START__TIME };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.DB_INSERT_CALL_AND_MENU_HISTORY, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TRANSACTION_RESULT, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.VIP__STATUS, "", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.DNIS_TRANSFER_FIELD_DNIS_TRANSFER_MENU,
			IProjectVariables.DNIS_TRANSFER_FIELD_IS_DNIS_TRANSFER };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.DNIS_TRANSFER, variableFields, null, session, false, false );
		session.putVariable(variable);
	 ...
	 * Last generated by Orchestration Designer at: 2021-APR-16  12:30:06 PM
	 */
